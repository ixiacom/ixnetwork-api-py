...
dBit_1 = ixNet.getAttribute('t1dev1' + '/isisL3Router:1', '-dBit')
ixNet.setMultiAttribute(dBit_1, '-clearOverlays', 'false')
ixNet.commit()
single_value_1 = ixNet.add(dBit_1, 'singleValue')
ixNet.setMultiAttribute('single_value_1', '-value', 'true')
ixNet.commit()
dBit_1 = (ixNet.getAttribute('t2dev1' + '/isisL3Router:1', '-dBit')
ixNet.setMultiAttribute('dBit_1 '-clearOverlays', 'false')
ixNet.commit()
single_value_1 = (ixNet.add(dBit_1, 'singleValue')
ixNet.setMultiAttribute('single_value_1', '-value', 'true')
...
sBit_1 = (ixNet.getAttribute('t1dev1' + '/isisL3Router:1', '-sBit')
ixNet.setMultiAttribute(sBit_1, '-clearOverlays', 'false')
ixNet.commit()
single_value_1 = ixNet.add(sBit_1, 'singleValue')
ixNet.setMultiAttribute('single_value_1', '-value', 'true')
ixNet.commit()
sBit_1 = (ixNet.getAttribute('t2dev1' + '/isisL3Router:1', '-sBit')
ixNet.setMultiAttribute(sBit_1, '-clearOverlays', 'false')
ixNet.commit()
single_value_1 = ixNet.add(sBit_1, 'singleValue')
ixNet.setMultiAttribute(single_value_1, '-value', 'true')
...
configureSIDIndexLabel_1 = (ixNet.getAttribute('t1dev1' + '/isisL3Router:1', '-configureSIDIndexLabel')
...
ixNet.setMultiAttribute(single_value_1, '-value', 'false')
ixNet.commit()
configureSIDIndexLabel_1 = ixNet.getAttribute('t2dev1' + '/isisL3Router:1', '-configureSIDIndexLabel')
ixNet.setMultiAttribute('configureSIDIndexLabel_1', '-clearOverlays', 'false')
ixNet.commit()
single_value_1 = ixNet.add(configureSIDIndexLabel_1, 'singleValue')
ixNet.setMultiAttribute('single_value_1', '-value', 'false')
...
oFlagOfSRv6CapTlv_1 = ixNet.getAttribute('t1dev1' + '/isisL3Router:1', '-oFlagOfSRv6CapTlv')
ixNet.setMultiAttribute(oFlagOfSRv6CapTlv_1 '-clearOverlays', 'false')
ixNet.commit()
single_value_1 = ixNet.add(oFlagOfSRv6CapTlv_1, 'singleValue')
ixNet.setMultiAttribute('single_value_1', '-value', 'true')
ixNet.commit()
oFlagOfSRv6CapTlv_1 = ixNet.getAttribute('t2dev1' + '/isisL3Router:1', '-oFlagOfSRv6CapTlv')
ixNet.setMultiAttribute(oFlagOfSRv6CapTlv_1, '-clearOverlays', 'false')
ixNet.commit()
single_value_1 = ixNet.add(oFlagOfSRv6CapTlv_1, 'singleValue')
ixNet.setMultiAttribute('single_value_1', '-value', 'true')
...
eFlagOfSRv6CapTlv_1 = ixNet.getAttribute('t1dev1' + '/isisL3Router:1', '-eFlagOfSRv6CapTlv')
ixNet.setMultiAttribute(eFlagOfSRv6CapTlv_1 '-clearOverlays', 'false')
ixNet.commit()
single_value_1 = ixNet.add(eFlagOfSRv6CapTlv_1, 'singleValue')
ixNet.setMultiAttribute('single_value_1', '-value', 'true')
ixNet.commit()
eFlagOfSRv6CapTlv_1 = ixNet.getAttribute('t2dev1' + '/isisL3Router:1', '-eFlagOfSRv6CapTlv')
ixNet.setMultiAttribute(eFlagOfSRv6CapTlv_1, '-clearOverlays', 'false')
ixNet.commit()
single_value_1 = ixNet.add(eFlagOfSRv6CapTlv_1, 'singleValue')
ixNet.setMultiAttribute('single_value_1', '-value', 'true')
...
sBitForSRv6Cap_1 = ixNet.getAttribute('t1dev1' + '/isisL3Router:1', '-sBitForSRv6Cap')
ixNet.setMultiAttribute(sBitForSRv6Cap_1, '-clearOverlays', 'false')
ixNet.commit()
single_value_1 = ixNet.add(sBitForSRv6Cap_1, 'singleValue')
ixNet.setMultiAttribute('single_value_1', '-value', 'true')
ixNet.commit()
sBitForSRv6Cap_1 = ixNet.getAttribute('t2dev1' + '/isisL3Router:1', '-sBitForSRv6Cap')
ixNet.setMultiAttribute(sBitForSRv6Cap_1, '-clearOverlays', 'false')
ixNet.commit()
single_value_1 = ixNet.add(sBitForSRv6Cap_1, 'singleValue')
ixNet.setMultiAttribute('single_value_1', '-value', 'true')
...
dBitForSRv6Cap_1 = ixNet.getAttribute('t1dev1' + '/isisL3Router:1', '-dBitForSRv6Cap')
ixNet.setMultiAttribute(dBitForSRv6Cap_1, '-clearOverlays', 'false')
ixNet.commit()
single_value_1 = ixNet.add(dBitForSRv6Cap_1, 'singleValue')
ixNet.setMultiAttribute('single_value_1', '-value', 'true')
ixNet.commit()
dBitForSRv6Cap_1 = ixNet.getAttribute('t2dev1' + '/isisL3Router:1', '-dBitForSRv6Cap')
ixNet.setMultiAttribute(dBitForSRv6Cap_1, '-clearOverlays', 'false')
ixNet.commit()
single_value_1 = ixNet.add(dBitForSRv6Cap_1, 'singleValue')
ixNet.setMultiAttribute('single_value_1', '-value', 'true')
...
reservedInsideSRv6CapFlag_1 = ixNet.getAttribute('t1dev1' + '/isisL3Router:1', '-reservedInsideSRv6CapFlag')
...
ixNet.commit()
reservedInsideSRv6CapFlag_1 = ixNet.getAttribute('t2dev1' + '/isisL3Router:1', '-reservedInsideSRv6CapFlag')
ixNet.setMultiAttribute(reservedInsideSRv6CapFlag_1, '-clearOverlays', 'false')
ixNet.commit()
single_value_1 = ixNet.add('reservedInsideSRv6CapFlag_1', 'singleValue')
...
includeMaximumEndDSrhTLV_1 = ixNet.getAttribute('t1dev1' + '/isisL3Router:1', '-includeMaximumEndDSrhTLV')
...
ixNet.setMultiAttribute('single_value_1', '-value', 'true')
ixNet.commit()
includeMaximumEndDSrhTLV_1 = ixNet.getAttribute('t2dev1' + '/isisL3Router:1', '-includeMaximumEndDSrhTLV')
ixNet.setMultiAttribute(includeMaximumEndDSrhTLV_1, '-clearOverlays', 'false')
ixNet.commit()
single_value_1 = ixNet.add(includeMaximumEndDSrhTLV_1, 'singleValue')
ixNet.setMultiAttribute('single_value_1', '-value', 'true')
...
includeMaximumEndPopSrhTLV_1 = ixNet.getAttribute('t1dev1' + '/isisL3Router:1', '-includeMaximumEndPopSrhTLV')
...
ixNet.setMultiAttribute('single_value_1', '-value', 'true')
ixNet.commit()
includeMaximumEndPopSrhTLV_1 = ixNet.getAttribute('t2dev1' + '/isisL3Router:1', '-includeMaximumEndPopSrhTLV')
ixNet.setMultiAttribute(includeMaximumEndPopSrhTLV_1, '-clearOverlays', 'false')
ixNet.commit()
single_value_1 = ixNet.add(includeMaximumEndPopSrhTLV_1, 'singleValue')
ixNet.setMultiAttribute('single_value_1', '-value', 'true')
...
includeMaximumSLTLV_1 = ixNet.getAttribute('t1dev1' + '/isisL3Router:1', '-includeMaximumSLTLV')
...
ixNet.setMultiAttribute('single_value_1', '-value', 'true')
ixNet.commit()
includeMaximumSLTLV_1 = ixNet.getAttribute('t2dev1' + '/isisL3Router:1', '-includeMaximumSLTLV')
ixNet.setMultiAttribute(includeMaximumSLTLV_1, '-clearOverlays', 'false')
ixNet.commit()
single_value_1 = ixNet.add('includeMaximumSLTLV_1 'singleValue')
ixNet.setMultiAttribute('single_value_1', '-value', 'true')
...
includeMaximumTEncapSrhTLV_1 = ixNet.getAttribute('t1dev1' + '/isisL3Router:1', '-includeMaximumTEncapSrhTLV')
...
ixNet.setMultiAttribute('single_value_1', '-value', 'true')
ixNet.commit()
includeMaximumTEncapSrhTLV_1 = ixNet.getAttribute('t2dev1' + '/isisL3Router:1', '-includeMaximumTEncapSrhTLV')
ixNet.setMultiAttribute(includeMaximumTEncapSrhTLV_1, '-clearOverlays', 'false')
ixNet.commit()
single_value_1 = ixNet.add(includeMaximumTEncapSrhTLV_1, 'singleValue')
ixNet.setMultiAttribute('single_value_1', '-value', 'true')
...
includeMaximumTInsertSrhTLV_1 = ixNet.getAttribute('t1dev1' + '/isisL3Router:1', '-includeMaximumTInsertSrhTLV')
...
ixNet.setMultiAttribute('single_value_1', '-value', 'true')
ixNet.commit()
includeMaximumTInsertSrhTLV_1 = ixNet.getAttribute('t2dev1' + '/isisL3Router:1', '-includeMaximumTInsertSrhTLV')
ixNet.setMultiAttribute(includeMaximumTInsertSrhTLV_1, '-clearOverlays', 'false')
ixNet.commit()
single_value_1 = ixNet.add(includeMaximumTInsertSrhTLV_1, 'singleValue')
ixNet.setMultiAttribute('single_value_1', '-value', 'true')
...
#Enable the dBitForSRv6Cap
print "Enabling the dBitForSRv6Cap"
dBitInsideSRv6SidTLV_1 = ixNet.getAttribute('t1dev1' + '/isisL3Router:1', '-dBitInsideSRv6SidTLV')
...
ixNet.setMultiAttribute('single_value_1', '-value', 'true')
ixNet.commit()
dBitInsideSRv6SidTLV_1 = ixNet.getAttribute('t2dev1' + '/isisL3Router:1', '-dBitInsideSRv6SidTLV')
ixNet.setMultiAttribute(dBitInsideSRv6SidTLV_1, '-clearOverlays', 'false')
ixNet.commit()
single_value_1 = ixNet.add(dBitInsideSRv6SidTLV_1, 'singleValue')
ixNet.setMultiAttribute('single_value_1', '-value', 'true')
...
ixNet.setMultiAttribute('Network_Topology', + '/simRouter:1/isisL3PseudoRouter:1', '-enableSRtrue')
ixNet.commit()
...
ixNet.setMultiAttribute('Single_Value_1', '-value', 'false')
ixNet.commit()
configureSIDIndexLabel = ixNet.getAttribute('Network_Topology', + '/simRouter:1/isisL3PseudoRouter:1', '-configureSIDIndexLabel')
...
ixNet.setMultiAttribute('ipv4PrefixPools','-addrStepSupported', 'true')
...
statcap = ixNet.getAttr(viewPage, '-columnCaptions')
