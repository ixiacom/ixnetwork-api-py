...
eCpriRec1 = ixNet.add(ipv4Addr1, 'eCpriRec')
ixNet.commit()
...
################################################################################
print("Adding eCPRI REC Radio Channels on Topology1")
networkgroup1 = ixNet.add(device1, 'networkGroup')
ixNet.commit()
networkgroup1 = ixNet.remapIds(networkgroup1)[0]

eCpriRecRadio1 = ixNet.add(networkgroup1, 'eCpriRecRadioChannelsOrUsers')
ixNet.commit()
eCpriRecRadio1 = ixNet.remapIds(eCpriRecRadio1)[0]
...
eCpriRe2 = ixNet.add(ipv4Addr2, 'eCpriRe')
ixNet.commit()
...
################################################################################
print ('')
print ("Creating Traffic from eCPRI Radio Channels to IPv4")
