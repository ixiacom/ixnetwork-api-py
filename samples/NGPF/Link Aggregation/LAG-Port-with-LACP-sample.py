...
ixNet.add(lag1eth, 'nglacp')
ixNet.commit()
ixNet.add(lag2eth, 'nglacp')
ixNet.commit()

lag1lacp = ixNet.getList(lag1eth, 'nglacp')[0]
lag2lacp = ixNet.getList(lag2eth, 'nglacp')[0]

##################################################################################
# To ADD staticLAG as LAG protocol
#Command sets 
#ixNet.add(lag1eth, 'ngstaticlag')
#ixNet.commit()
#ixNet.add(lag2eth, 'ngstaticlag')
#ixNet.commit()
#lag1slag = ixNet.getList(lag1eth, 'ngstaticlag')[0]
#lag2slag = ixNet.getList(lag2eth, 'ngstaticlag')[0]
##################################################################################
